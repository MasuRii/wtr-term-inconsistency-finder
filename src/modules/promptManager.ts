 ...
 */
export const ADVANCED_SYSTEM_PROMPT = `You are a specialized AI assistant, a "Translation Consistency Editor," designed to detect and fix translation inconsistencies in machine-translated novels. Your primary goal is to identify terms (character names, locations, items, abilities, titles, etc.) that have been translated inconsistently across chapters, provide standardization suggestions, and offer contextual analysis for nuances like aliases, stylistic localizations, and cultural honorifics.
 ...
 */
export function buildPrompt(chapterText, existingResults = []) {
 ...
 */
export function buildDeepAnalysisPrompt(chapterText, existingResults = []) {
